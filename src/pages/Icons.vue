      ...
      <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
        <md-card class="md-card-plain">
          <md-card-header data-background-color="blue">
            <h4 class="title">APPLICATION SCENARIOS</h4>
          ...
          <md-card-content>
            <div class="cardcon">
              <md-card>
               <md-card-header>
                 <md-avatar>
                   <img src="../assets/img/app/scene-log1.png" alt="Avatar">
                 </md-avatar>

                 <div class="md-title">Trusted and secure data storage </div>
             ...
             <md-card>
              <md-card-header>
                <md-avatar>
                  <img src="../assets/img/app/scene-log2.png" alt="Avatar">
                </md-avatar>

                <div class="md-title">Public data access and transaction</div>
                  <div class="md-subhead">&nbsp; </div>
            ...
            <md-card>
             <md-card-header>
               <md-avatar>
                 <img src="../assets/img/app/scene-log3.png" alt="Avatar">
               </md-avatar>

               <div class="md-title">Access control and protection of personal privacy data</div>
                 <div class="md-subhead">&nbsp;</div>
           ...
           <md-card>
            <md-card-header>
              <md-avatar>
                <img src="../assets/img/app/scene-log4.png" alt="Avatar">
              </md-avatar>

              <div class="md-title">DApp and Blockchain</div>
                <div class="md-subhead">&nbsp;</div>
          ...
          <md-card>
           <md-card-header>
             <md-avatar>
               <img src="../assets/img/app/scene-log5.png" alt="Avatar">
             </md-avatar>

             <div class="md-title">IoT data storage</div>
               <div class="md-subhead">&nbsp;</div>
         ...
         <md-card>
          <md-card-header>
            <md-avatar>
              <img src="../assets/img/app/scene-log6.png" alt="Avatar">
            </md-avatar>

            <div class="md-title">Artificial intelligence data</div>
              <div class="md-subhead">&nbsp;</div>
